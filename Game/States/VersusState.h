...
class VersusState final : public GameState, public dae::IEventListener
{
public:
...
private:
	...
	void BindVersusPlayer(dae::GameObject* player, dae::GameObject* turretPtr);
	...
	dae::GameObject* m_PlayerOneTurret{};

	dae::GameObject* m_VersusPlayer{};
	dae::GameObject* m_VersusPlayerTurret{};
};