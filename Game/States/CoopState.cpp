...
void CoopState::OnEvent(const dae::Event& event)
{
...
void CoopState::LoadLevel()
{
	...
	BindPlayerOneInput(playerOneObjects.player, playerOneObjects.turret);
	//Player Two Initialization
	glm::vec2 playerTwoSpawn = tron::GetPlayerTwoStartPos(*currentLevel);
	auto playerTwoObjects = tron::CreatePlayerTwo(scene, playerTwoSpawn, *currentLevel);
	BindPlayerTwoInput(playerTwoObjects.player, playerTwoObjects.turret);
...
void CoopState::BindPlayerOneInput(dae::GameObject* player, dae::GameObject*turretPtr)
{
...
void CoopState::BindPlayerTwoInput(dae::GameObject* player, dae::GameObject* turretPtr)
{
